...
- Client
  ...
  - Terms
    ...
    - Cookies
  - Editor
    - Change Expert Editor to conditionally add double quotes around input with conflicting characters, e.g., commas
  - Profile
    - Style menu
      - Find icons to replace logo placeholder
    - Refactor pushing container down to child
    - Implement narrower segment to mimic style of other password-related forms
  - Match
